...
describe("QaWolf.com  ", () => {
    ...
    // });
    // it('user should be able to select  industries and click on Enterprise', async () => {
    //     if(true){
    //     await Homepage.startUps('industries', 'Enterprise');
    //     }
    //     expect(await Homepage.$pageHeader('Enterprise').isDisplayed()).toBe(true, 'Expect Enterprise page header to be displayed');
